...
- `orientation-principles-learning`: Deset principů v sekci orientace musí u každého záznamu zobrazovat navíc strukturovaný obsah sekcí „Tipy a triky“ a „Příběhy z praxe“, načtený z datového zdroje pravdy aplikace, s důrazem na čitelnost a přístupnost.
...
- **Seed**: rozšíření `scripts/seed.ts` o texty pro všech deset principů.
